...
namespace MP4.Boxes
{
    public class MOOVTests : BoxTestCore
    {
        ...
        public unsafe void Read_Valid2Track_AllValueAreEqual()
        {
            fixed (byte* ptr = moovBuffer)
            {
               ...
               var error = ISOBMFF.Read(ref context, ref reader, moovBox);
                ...
                //MVHD
                Assert.AreEqual(501120, context.MVHD.Duration, "MVHD.Duration");
                Assert.AreEqual(90000, context.MVHD.Timescale, "MVHD.Timescale");
                Assert.AreEqual(3, context.MVHD.NextTrackID, "MVHD.NextTrackID");
                ...
                Assert.AreEqual(1, track1.TKHD.TrackID, "track1.TKHD.TrackID");     
                Assert.AreEqual(498000, track1.MDHD.Duration, "track1.MDHD.Duration");
                Assert.AreEqual(90000, track1.MDHD.Timescale, "track1.MDHD.Timescale");
                Assert.AreEqual(ISOLanguage.UND, track1.MDHD.Language, "track1.MDHD.Language");
                Assert.AreEqual(385, track1.STSD.Index, "track1.STSD.Index");
                ...
                Assert.AreEqual(2, track2.TKHD.TrackID, "track2.TKHD.TrackID");
                Assert.AreEqual(267264, track2.MDHD.Duration, "track2.MDHD.Duration");
                Assert.AreEqual(48000, track2.MDHD.Timescale, "track2.MDHD.Timescale");
                Assert.AreEqual(ISOLanguage.ENG, track2.MDHD.Language, "track2.MDHD.Language");
                Assert.AreEqual(1927, track2.STSD.Index, "track2.STSD.Index");
        ...
        readonly int moovIndex = 380040;

        readonly byte[] moovBuffer = {
